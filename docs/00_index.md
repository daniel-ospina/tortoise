...
| **Canonical SDK method surface** — the target list for `TortoiseSDK` (150 public methods → 36 groups), with the true duplicates, the do-not-merge blockers, the competitor evidence, and the read-named methods that write (#1521) | `docs/product/canonical-sdk-methods.md` |
