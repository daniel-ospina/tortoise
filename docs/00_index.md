...
| **Vision — the MCP and SDK surface** — the target surface, the implementation plan from it, which artifact governs which, and the lanes blocked on this (#1521). The two formerly-open items are settled and applied, so nothing here awaits the owner | `docs/product/vision-mcp-sdk-surface.md` |
