...
| **Canonical SDK method surface** — the target list for `TortoiseSDK` (150 public methods → 32 groups), with the true duplicates, the do-not-merge blockers, the competitor evidence, and the read-named methods that write (#1521) | `docs/product/canonical-sdk-methods.md` |
...
| **Vision — the MCP and SDK surface** — the target surface, the implementation plan from it, the two items awaiting the owner, and the four lanes blocked on this (#1521) | `docs/product/vision-mcp-sdk-surface.md` |
