...
| #2552 operator-edges open owner decisions ledger — Q1 (measure extraction against the new operator gold?) + Q2 (what `MITIGATES` means, which shape is canonical) | `docs/scoping/2026-09-22-2552-operator-edges-decisions.md` |
