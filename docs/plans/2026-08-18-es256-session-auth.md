...
- `verify_session_jwt`:
  ...
  try:
      ...
      claims = pyjwt.decode(
          ...
          leeway=30,
          options={"require": ["sub", "exp", "iat"], "verify_iat": True, "verify_nbf": True, "strict_aud": True},
      )
