...
**Files:**
- Modify: `tortoise/hosted_api.py` (:6106 mint site, :10477 mint site)

**Step 1:** Edit `_create_team_supabase_lane` (hosted_api.py:6106):
```python
...
**Step 2:** Edit `_create_onboarding_team_lane` Supabase branch (hosted_api.py:10477):
```python
team_id = str(_uuid.uuid4().hex[:26])
