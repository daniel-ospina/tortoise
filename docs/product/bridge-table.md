...
|---|---|---|---|---|---|
| 1 | `tortoise_analyze` | `tool_registry.py:796` | `analyze` ⚠️ **does not resolve** | yes | `REMOVED` |
...
| 4 | `tortoise_assess_source` | `tool_registry.py:981` | `assess_source` | no | `manage_source_trust` |
| 5 | `tortoise_audit` | `tool_registry.py:153` | `audit` | yes | `graph_overview` |
| 6 | `tortoise_backfill_v25` | `tool_registry.py:1124` | `backfill_v25` | no | `REMOVED` |
...
| 10 | `tortoise_checkpoint` | `tool_registry.py:613` | `checkpoint` | no | `REMOVED` |
| 11 | `tortoise_compute_confidence` | `tool_registry.py:386` | `compute_confidence` | yes | `check_confidence` |
| 12 | `tortoise_create_document` | `tool_registry.py:949` | `create_document` | no | `create_entity` |
| 13 | `tortoise_create_edge` | `tool_registry.py:1080` | `create_edge` | no | `link_entities` |
| 14 | `tortoise_create_entity` | `tool_registry.py:1033` | `create_entity` | no | `create_entity` |
| 15 | `tortoise_create_event` | `tool_registry.py:889` | `create_event` | no | `create_entity` |
| 16 | `tortoise_create_object` | `tool_registry.py:880` | `create_object` | no | `create_entity` |
...
| 19 | `tortoise_create_source` | `tool_registry.py:958` | `create_source` | no | `register_source` |
| 20 | `tortoise_create_subject` | `tool_registry.py:871` | `create_subject` | no | `create_entity` |
| 21 | `tortoise_delete` | `tool_registry.py:1056` | `delete` | no | `delete_knowledge` |
| 22 | `tortoise_delete_entity` | `tool_registry.py:1022` | `delete_entity` | no | `delete_knowledge` |
| 23 | `tortoise_delete_point` | `tool_registry.py:533` | `delete_point_wrapped` | no | `delete_knowledge` |
| 24 | `tortoise_diary_read` | `tool_registry.py:633` | `diary_read` | yes | `REMOVED` |
| 25 | `tortoise_diary_write` | `tool_registry.py:623` | `diary_write` | no | `REMOVED` |
...
| 28 | `tortoise_entity_profile` | `tool_registry.py:593` | `entity_profile` ⚠️ **does not resolve** | yes | `explore_connections` |
| 29 | `tortoise_events_poll` | `tool_registry.py:568` | `events_poll` | yes | `poll_events` |
...
| 33 | `tortoise_find_cross_lens_candidates` | `tool_registry.py:832` | `get_cross_lens_candidates` | yes | `review_link_candidates` |
| 34 | `tortoise_get` | `tool_registry.py:1113` | **none declared** | yes | `get_entity` |
| 35 | `tortoise_get_confidence` | `tool_registry.py:415` | `get_confidence` | yes | `check_confidence` |
| 36 | `tortoise_get_entity` | `tool_registry.py:1002` | `get_entity` | yes | `get_entity` |
| 37 | `tortoise_get_events` | `tool_registry.py:898` | `get_events` | yes | `get_entity` |
| 38 | `tortoise_get_governance` | `tool_registry.py:1093` | `get_owned_entities` | yes | `get_entity` |
...
| 41 | `tortoise_get_session` | `tool_registry.py:906` | `get_session` | yes | `get_entity` |
| 42 | `tortoise_get_source_reliability` | `tool_registry.py:970` | `get_source_reliability` | no | `list_knowledge` |
| 43 | `tortoise_graph_set_recording` | `tool_registry.py:702` | **none declared** | no | `graph_set_recording` |
| 44 | `tortoise_health` | `tool_registry.py:658` | `health` ⚠️ **does not resolve** | yes | `graph_overview` |
| 45 | `tortoise_index_files` | `tool_registry.py:924` | `index_directory` | no | `index_sources_from_directory` |
| 46 | `tortoise_index_sessions` | `tool_registry.py:914` | `index_sessions` | no | `index_sources_from_directory` |
| 47 | `tortoise_ingest` | `tool_registry.py:745` | `ingest` | no | `sdk:write_knowledge_batch` |
| 48 | `tortoise_ingest_corpus` | `tool_registry.py:735` | `ingest_corpus` | no | `index_sources_from_directory` |
| 49 | `tortoise_invalidate` | `tool_registry.py:544` | `invalidate_point` | no | `supersede_knowledge` |
| 50 | `tortoise_issue_insight` | `tool_registry.py:721` | `issue_insight` | yes | `search_knowledge` |
...
| 54 | `tortoise_list_graphs` | `tool_registry.py:641` | `list_graphs` | yes | `tenancy:list_memory_graphs` |
...
| 59 | `tortoise_list_topics` | `tool_registry.py:785` | `list_topics` | yes | `list_knowledge` |
...
| 62 | `tortoise_onboarding_demo_create` | `tool_registry.py:1134` | **none declared** | no | `REMOVED` |
| 63 | `tortoise_onboarding_github_connect` | `tool_registry.py:1177` | **none declared** | no | `REMOVED` |
| 64 | `tortoise_onboarding_github_index` | `tool_registry.py:1187` | **none declared** | no | `REMOVED` |
| 65 | `tortoise_onboarding_github_status` | `tool_registry.py:1197` | **none declared** | yes | `REMOVED` |
| 66 | `tortoise_onboarding_seed` | `tool_registry.py:1153` | **none declared** | no | `REMOVED` |
| 67 | `tortoise_onboarding_session_recording` | `tool_registry.py:1167` | **none declared** | no | `REMOVED` |
| 68 | `tortoise_onboarding_state` | `tool_registry.py:1144` | **none declared** | yes | `REMOVED` |
| 69 | `tortoise_operator_action` | `tool_registry.py:1068` | `operator_action` | no | `adjust_relationship` |
| 70 | `tortoise_org_create` | `tool_registry.py:860` | `org_create` | no | `tenancy:create_memory_graph` |
| 71 | `tortoise_overview` | `tool_registry.py:1102` | **none declared** | yes | `graph_overview` |
...
| 76 | `tortoise_provenance` | `tool_registry.py:850` | `provenance` | yes | `check_confidence` |
...
| 80 | `tortoise_retract_point` | `tool_registry.py:580` | `retract_point` | no | `update_knowledge` |
| 81 | `tortoise_review_connections` | `tool_registry.py:814` | `review_connections` | yes | `review_link_candidates` |
| 82 | `tortoise_search` | `tool_registry.py:278` | `tortoise_fts_query` | yes | `search_knowledge` |
| 83 | `tortoise_search_sessions` | `tool_registry.py:941` | `search_sessions` | yes | `search_knowledge` |
| 84 | `tortoise_session_capture` | `tool_registry.py:676` | **none declared** | no | `mine_knowledge_from_session` |
| 85 | `tortoise_session_context` | `tool_registry.py:666` | `session_context` | yes | `check_confidence` |
| 86 | `tortoise_set_point_baseline` | `tool_registry.py:406` | `set_point_baseline` | no | `refresh_confidence` ⚠️ |
| 87 | `tortoise_set_source_tier` | `tool_registry.py:992` | `set_source_tier` | no | `manage_source_trust` |
| 88 | `tortoise_stale` | `tool_registry.py:806` | `stale_points` | yes | `graph_overview` |
| 89 | `tortoise_status` | `tool_registry.py:649` | `status` | yes | `graph_overview` |
...
| 92 | `tortoise_supersede` | `tool_registry.py:554` | `supersede` | no | `supersede_knowledge` |
| 93 | `tortoise_taxonomy` | `tool_registry.py:776` | `taxonomy` | yes | `graph_overview` |
| 94 | `tortoise_traverse` | `tool_registry.py:603` | `traverse` | yes | `explore_connections` |
| 95 | `tortoise_update` | `tool_registry.py:1045` | `update` | no | `update_knowledge` |
| 96 | `tortoise_update_entity` | `tool_registry.py:1013` | `update_entity` | no | `update_knowledge` |
...
| `tortoise_entity_profile` | `entity_profile` | `tool_registry.py:593` |
| `tortoise_analyze` | `analyze` | `tool_registry.py:796` |
| `tortoise_health` | `health` | `tool_registry.py:658` |
