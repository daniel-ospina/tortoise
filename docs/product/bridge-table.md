...
|---|---|---|---|---|---|
| 1 | `tortoise_analyze` | `tool_registry.py:804` | `analyze` ⚠️ **does not resolve** | yes | `REMOVED` |
| 2 | `tortoise_annotate_operator` | `tool_registry.py:493` | `annotate_operator` | no | `adjust_relationship` |
| 3 | `tortoise_approve_merge` | `tool_registry.py:365` | `approve_merge` | no | `approve_merge` |
| 4 | `tortoise_assess_source` | `tool_registry.py:989` | `assess_source` | no | `manage_source_trust` |
| 5 | `tortoise_audit` | `tool_registry.py:166` | `audit` | yes | `graph_overview` |
| 6 | `tortoise_backfill_v25` | `tool_registry.py:1128` | `backfill_v25` | no | `REMOVED` |
| 7 | `tortoise_belief_timeline` | `tool_registry.py:388` | `belief_timeline` | yes | `check_confidence` |
| 8 | `tortoise_calibrate_summary` | `tool_registry.py:436` | `calibrate_summary` | yes | `check_confidence` |
| 9 | `tortoise_check_structure` | `tool_registry.py:133` | `check_structure` | yes | `graph_overview` |
| 10 | `tortoise_checkpoint` | `tool_registry.py:621` | `checkpoint` | no | `REMOVED` |
| 11 | `tortoise_compute_confidence` | `tool_registry.py:399` | `compute_confidence` | yes | `check_confidence` |
| 12 | `tortoise_create_document` | `tool_registry.py:957` | `create_document` | no | `create_entity` |
| 13 | `tortoise_create_edge` | `tool_registry.py:1084` | `create_edge` | no | `link_entities` |
| 14 | `tortoise_create_entity` | `tool_registry.py:1039` | `create_entity` | no | `create_entity` |
| 15 | `tortoise_create_event` | `tool_registry.py:897` | `create_event` | no | `create_entity` |
| 16 | `tortoise_create_object` | `tool_registry.py:888` | `create_object` | no | `create_entity` |
| 17 | `tortoise_create_operator` | `tool_registry.py:483` | `create_operator` | no | `link_entities` |
| 18 | `tortoise_create_point` | `tool_registry.py:98` | `create_point` | no | `create_entity` |
| 19 | `tortoise_create_source` | `tool_registry.py:966` | `create_source` | no | `register_source` |
| 20 | `tortoise_create_subject` | `tool_registry.py:879` | `create_subject` | no | `create_entity` |
| 21 | `tortoise_delete` | `tool_registry.py:1062` | `delete` | no | `delete_knowledge` |
| 22 | `tortoise_delete_entity` | `tool_registry.py:1030` | `delete_entity` | no | `delete_knowledge` |
| 23 | `tortoise_delete_point` | `tool_registry.py:546` | `delete_point_wrapped` | no | `delete_knowledge` |
| 24 | `tortoise_diary_read` | `tool_registry.py:641` | `diary_read` | yes | `REMOVED` |
| 25 | `tortoise_diary_write` | `tool_registry.py:631` | `diary_write` | no | `REMOVED` |
| 26 | `tortoise_dream` | `tool_registry.py:444` | `dream` | no | `refresh_confidence` |
| 27 | `tortoise_dream_health` | `tool_registry.py:460` | `dream_health_check` | yes | `graph_overview` |
| 28 | `tortoise_entity_profile` | `tool_registry.py:601` | `entity_profile` ⚠️ **does not resolve** | yes | `explore_connections` |
| 29 | `tortoise_events_poll` | `tool_registry.py:577` | `events_poll` | yes | `poll_events` |
| 30 | `tortoise_expand_relationships` | `tool_registry.py:303` | `expand_relationships` | yes | `explore_connections` |
| 31 | `tortoise_file_decision` | `tool_registry.py:523` | `file_decision` | no | `write_question` |
| 32 | `tortoise_file_human_approval` | `tool_registry.py:533` | `file_human_approval` | no | `record_decision` |
| 33 | `tortoise_find_cross_lens_candidates` | `tool_registry.py:840` | `get_cross_lens_candidates` | yes | `review_link_candidates` |
| 34 | `tortoise_get` | `tool_registry.py:1117` | **none declared** | yes | `get_entity` |
| 35 | `tortoise_get_confidence` | `tool_registry.py:428` | `get_confidence` | yes | `check_confidence` |
| 36 | `tortoise_get_entity` | `tool_registry.py:1010` | `get_entity` | yes | `get_entity` |
| 37 | `tortoise_get_events` | `tool_registry.py:906` | `get_events` | yes | `get_entity` |
| 38 | `tortoise_get_governance` | `tool_registry.py:1097` | `get_owned_entities` | yes | `get_entity` |
| 39 | `tortoise_get_operator` | `tool_registry.py:503` | `get_point` | yes | `get_entity` |
| 40 | `tortoise_get_point` | `tool_registry.py:274` | `get_point` | yes | `get_entity` |
| 41 | `tortoise_get_session` | `tool_registry.py:914` | `get_session` | yes | `get_entity` |
| 42 | `tortoise_get_source_reliability` | `tool_registry.py:978` | `get_source_reliability` | no | `list_knowledge` |
| 43 | `tortoise_graph_set_recording` | `tool_registry.py:710` | **none declared** | no | `graph_set_recording` |
| 44 | `tortoise_health` | `tool_registry.py:666` | `health` ⚠️ **does not resolve** | yes | `graph_overview` |
| 45 | `tortoise_index_files` | `tool_registry.py:932` | `index_directory` | no | `index_sources_from_directory` |
| 46 | `tortoise_index_sessions` | `tool_registry.py:922` | `index_sessions` | no | `index_sources_from_directory` |
| 47 | `tortoise_ingest` | `tool_registry.py:753` | `ingest` | no | `sdk:write_knowledge_batch` |
| 48 | `tortoise_ingest_corpus` | `tool_registry.py:743` | `ingest_corpus` | no | `index_sources_from_directory` |
| 49 | `tortoise_invalidate` | `tool_registry.py:555` | `invalidate_point` | no | `supersede_knowledge` |
| 50 | `tortoise_issue_insight` | `tool_registry.py:729` | `issue_insight` | yes | `search_knowledge` |
| 51 | `tortoise_list_batch` | `tool_registry.py:206` | `list_batch` | yes | `list_knowledge` |
| 52 | `tortoise_list_batches` | `tool_registry.py:218` | `list_batches` | yes | `list_knowledge` |
| 53 | `tortoise_list_dedup_candidates` | `tool_registry.py:356` | `list_dedup_candidates` | yes | `review_link_candidates` |
| 54 | `tortoise_list_graphs` | `tool_registry.py:649` | `list_graphs` | yes | `tenancy:list_memory_graphs` |
| 55 | `tortoise_list_namespaces` | `tool_registry.py:197` | `list_namespaces` | yes | `list_knowledge` |
| 56 | `tortoise_list_pointkinds` | `tool_registry.py:181` | `list_pointkinds` | yes | `graph_overview` |
| 57 | `tortoise_list_sources` | `tool_registry.py:189` | `list_sources` | yes | `graph_overview` |
| 58 | `tortoise_list_tags` | `tool_registry.py:256` | `list_tags` | yes | `graph_overview` |
| 59 | `tortoise_list_topics` | `tool_registry.py:793` | `list_topics` | yes | `list_knowledge` |
| 60 | `tortoise_mine_conversations` | `tool_registry.py:342` | `mine_corpus` | no | `mine_knowledge_from_directory` |
| 61 | `tortoise_mitigate_operator` | `tool_registry.py:512` | `mitigate_operator` | no | `adjust_relationship` |
| 62 | `tortoise_onboarding_demo_create` | `tool_registry.py:1138` | **none declared** | no | `REMOVED` |
| 63 | `tortoise_onboarding_github_connect` | `tool_registry.py:1181` | **none declared** | no | `REMOVED` |
| 64 | `tortoise_onboarding_github_index` | `tool_registry.py:1191` | **none declared** | no | `REMOVED` |
| 65 | `tortoise_onboarding_github_status` | `tool_registry.py:1201` | **none declared** | yes | `REMOVED` |
| 66 | `tortoise_onboarding_seed` | `tool_registry.py:1157` | **none declared** | no | `REMOVED` |
| 67 | `tortoise_onboarding_session_recording` | `tool_registry.py:1171` | **none declared** | no | `REMOVED` |
| 68 | `tortoise_onboarding_state` | `tool_registry.py:1148` | **none declared** | yes | `REMOVED` |
| 69 | `tortoise_operator_action` | `tool_registry.py:1072` | `operator_action` | no | `adjust_relationship` |
| 70 | `tortoise_org_create` | `tool_registry.py:868` | `org_create` | no | `tenancy:create_memory_graph` |
| 71 | `tortoise_overview` | `tool_registry.py:1106` | **none declared** | yes | `graph_overview` |
| 72 | `tortoise_pack_install` | `tool_registry.py:239` | `upsert_tenant_manifest` ⚠️ **does not resolve** | no | `REMOVED` |
| 73 | `tortoise_packs_list` | `tool_registry.py:228` | `get_tenant_packs` ⚠️ **does not resolve** | yes | `REMOVED` |
| 74 | `tortoise_paginated_query` | `tool_registry.py:124` | `paginated_query` | yes | `search_knowledge` |
| 75 | `tortoise_promote_point` | `tool_registry.py:376` | `promote_point` | no | `refresh_confidence` |
| 76 | `tortoise_provenance` | `tool_registry.py:858` | `provenance` | yes | `check_confidence` |
| 77 | `tortoise_query` | `tool_registry.py:111` | `query` | yes | `search_knowledge` |
| 78 | `tortoise_query_points_by_tag` | `tool_registry.py:264` | `query_points_by_tag` | yes | `search_knowledge` |
| 79 | `tortoise_recall` | `tool_registry.py:314` | `recall_state` | yes | `check_confidence` |
| 80 | `tortoise_retract_point` | `tool_registry.py:589` | `retract_point` | no | `update_knowledge` |
| 81 | `tortoise_review_connections` | `tool_registry.py:822` | `review_connections` | yes | `review_link_candidates` |
| 82 | `tortoise_search` | `tool_registry.py:291` | `tortoise_fts_query` | yes | `search_knowledge` |
| 83 | `tortoise_search_sessions` | `tool_registry.py:949` | `search_sessions` | yes | `search_knowledge` |
| 84 | `tortoise_session_capture` | `tool_registry.py:684` | **none declared** | no | `mine_knowledge_from_session` |
| 85 | `tortoise_session_context` | `tool_registry.py:674` | `session_context` | yes | `check_confidence` |
| 86 | `tortoise_set_point_baseline` | `tool_registry.py:419` | `set_point_baseline` | no | `refresh_confidence` |
| 87 | `tortoise_set_source_tier` | `tool_registry.py:1000` | `set_source_tier` | no | `manage_source_trust` |
| 88 | `tortoise_stale` | `tool_registry.py:814` | `stale_points` | yes | `graph_overview` |
| 89 | `tortoise_status` | `tool_registry.py:657` | `status` | yes | `graph_overview` |
| 90 | `tortoise_suggest_entry_points` | `tool_registry.py:282` | `suggest_entry_points` | yes | `search_knowledge` |
| 91 | `tortoise_summarize_structure` | `tool_registry.py:153` | `summarize_structure` | yes | `graph_overview` |
| 92 | `tortoise_supersede` | `tool_registry.py:564` | `supersede` | no | `supersede_knowledge` |
| 93 | `tortoise_taxonomy` | `tool_registry.py:784` | `taxonomy` | yes | `graph_overview` |
| 94 | `tortoise_traverse` | `tool_registry.py:611` | `traverse` | yes | `explore_connections` |
| 95 | `tortoise_update` | `tool_registry.py:1051` | `update` | no | `update_knowledge` |
| 96 | `tortoise_update_entity` | `tool_registry.py:1021` | `update_entity` | no | `update_knowledge` |
| 97 | `tortoise_update_point` | `tool_registry.py:473` | `update_point` | no | `update_knowledge` |
| 98 | `tortoise_validate_domain` | `tool_registry.py:141` | `validate_domain` | yes | `graph_overview` |
...
|---|---|---|
| `tortoise_packs_list` | `get_tenant_packs` | `tool_registry.py:228` |
| `tortoise_pack_install` | `upsert_tenant_manifest` | `tool_registry.py:239` |
| `tortoise_entity_profile` | `entity_profile` | `tool_registry.py:601` |
| `tortoise_analyze` | `analyze` | `tool_registry.py:804` |
| `tortoise_health` | `health` | `tool_registry.py:666` |
