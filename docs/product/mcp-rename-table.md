...
|---|---|---|---|---|---|
| 1 | `tortoise_analyze` | `tool_registry.py:806` | **no replacement** | `REMOVED` | absent |
...
| 4 | `tortoise_assess_source` | `tool_registry.py:991` | **no replacement** | `manage_source_trust` | absent |
| 5 | `tortoise_audit` | `tool_registry.py:168` | **no replacement** | `graph_overview` | absent |
| 6 | `tortoise_backfill_v25` | `tool_registry.py:1130` | **no replacement** | `REMOVED` | absent |
...
| 10 | `tortoise_checkpoint` | `tool_registry.py:623` | **no replacement** | `REMOVED` | absent |
| 11 | `tortoise_compute_confidence` | `tool_registry.py:401` | **no replacement** | `check_confidence` | absent |
| 12 | `tortoise_create_document` | `tool_registry.py:959` | **no replacement** | `create_entity` | absent |
| 13 | `tortoise_create_edge` | `tool_registry.py:1086` | **no replacement** | `link_entities` | absent |
| 14 | `tortoise_create_entity` | `tool_registry.py:1041` | **no replacement** | `create_entity` | absent |
| 15 | `tortoise_create_event` | `tool_registry.py:899` | **no replacement** | `create_entity` | absent |
| 16 | `tortoise_create_object` | `tool_registry.py:890` | **no replacement** | `create_entity` | absent |
...
| 19 | `tortoise_create_source` | `tool_registry.py:968` | **no replacement** | `register_source` | absent |
| 20 | `tortoise_create_subject` | `tool_registry.py:881` | **no replacement** | `create_entity` | absent |
| 21 | `tortoise_delete` | `tool_registry.py:1064` | **no replacement** | `delete_knowledge` | absent |
| 22 | `tortoise_delete_entity` | `tool_registry.py:1032` | **no replacement** | `delete_knowledge` | absent |
| 23 | `tortoise_delete_point` | `tool_registry.py:548` | **no replacement** | `delete_knowledge` | absent |
| 24 | `tortoise_diary_read` | `tool_registry.py:643` | **no replacement** | `REMOVED` | absent |
| 25 | `tortoise_diary_write` | `tool_registry.py:633` | **no replacement** | `REMOVED` | absent |
...
| 28 | `tortoise_entity_profile` | `tool_registry.py:603` | **no replacement** | `explore_connections` | absent |
| 29 | `tortoise_events_poll` | `tool_registry.py:579` | **no replacement** | `poll_events` | absent |
...
| 33 | `tortoise_find_cross_lens_candidates` | `tool_registry.py:842` | **no replacement** | `review_link_candidates` | absent |
| 34 | `tortoise_get` | `tool_registry.py:1119` | `tortoise_get_entity(id, type=...)` | `get_entity` | warning shim |
| 35 | `tortoise_get_confidence` | `tool_registry.py:430` | **no replacement** | `check_confidence` | absent |
| 36 | `tortoise_get_entity` | `tool_registry.py:1012` | **no replacement** | `get_entity` | absent |
| 37 | `tortoise_get_events` | `tool_registry.py:908` | `tortoise_get_entity(None, type="events")` | `get_entity` | warning shim |
| 38 | `tortoise_get_governance` | `tool_registry.py:1099` | `tortoise_get_entity(id, type="governance")` | `get_entity` | warning shim |
...
| 41 | `tortoise_get_session` | `tool_registry.py:916` | **no replacement** | `get_entity` | absent |
| 42 | `tortoise_get_source_reliability` | `tool_registry.py:980` | **no replacement** | `list_knowledge` | absent |
| 43 | `tortoise_graph_set_recording` | `tool_registry.py:712` | **no replacement** | `graph_set_recording` | absent |
| 44 | `tortoise_health` | `tool_registry.py:668` | `tortoise_overview(section="health")` | `graph_overview` | warning shim |
| 45 | `tortoise_index_files` | `tool_registry.py:934` | **no replacement** | `index_sources_from_directory` | absent |
| 46 | `tortoise_index_sessions` | `tool_registry.py:924` | `tortoise_index_files(directory)` | `index_sources_from_directory` | warning shim |
| 47 | `tortoise_ingest` | `tool_registry.py:755` | **no replacement** | `sdk:write_knowledge_batch` | absent |
| 48 | `tortoise_ingest_corpus` | `tool_registry.py:745` | `tortoise_index_files(directory)` | `index_sources_from_directory` | warning shim |
| 49 | `tortoise_invalidate` | `tool_registry.py:557` | **no replacement** | `supersede_knowledge` | absent |
| 50 | `tortoise_issue_insight` | `tool_registry.py:731` | **no replacement** | `search_knowledge` | absent |
...
| 54 | `tortoise_list_graphs` | `tool_registry.py:651` | **no replacement** | `tenancy:list_memory_graphs` | absent |
...
| 59 | `tortoise_list_topics` | `tool_registry.py:795` | **no replacement** | `list_knowledge` | absent |
...
| 62 | `tortoise_onboarding_demo_create` | `tool_registry.py:1140` | **no replacement** | `REMOVED` | absent |
| 63 | `tortoise_onboarding_github_connect` | `tool_registry.py:1183` | **no replacement** | `REMOVED` | absent |
| 64 | `tortoise_onboarding_github_index` | `tool_registry.py:1193` | **no replacement** | `REMOVED` | absent |
| 65 | `tortoise_onboarding_github_status` | `tool_registry.py:1203` | **no replacement** | `REMOVED` | absent |
| 66 | `tortoise_onboarding_seed` | `tool_registry.py:1159` | **no replacement** | `REMOVED` | absent |
| 67 | `tortoise_onboarding_session_recording` | `tool_registry.py:1173` | **no replacement** | `REMOVED` | absent |
| 68 | `tortoise_onboarding_state` | `tool_registry.py:1150` | **no replacement** | `REMOVED` | absent |
| 69 | `tortoise_operator_action` | `tool_registry.py:1074` | **no replacement** | `adjust_relationship` | absent |
| 70 | `tortoise_org_create` | `tool_registry.py:870` | **no replacement** | `tenancy:create_memory_graph` | absent |
| 71 | `tortoise_overview` | `tool_registry.py:1108` | **no replacement** | `graph_overview` | absent |
...
| 76 | `tortoise_provenance` | `tool_registry.py:860` | **no replacement** | `check_confidence` | absent |
...
| 80 | `tortoise_retract_point` | `tool_registry.py:591` | **no replacement** | `update_knowledge` | absent |
| 81 | `tortoise_review_connections` | `tool_registry.py:824` | **no replacement** | `review_link_candidates` | absent |
| 82 | `tortoise_search` | `tool_registry.py:293` | **no replacement** | `search_knowledge` | absent |
| 83 | `tortoise_search_sessions` | `tool_registry.py:951` | **no replacement** | `search_knowledge` | absent |
| 84 | `tortoise_session_capture` | `tool_registry.py:686` | **no replacement** | `mine_knowledge_from_session` | absent |
| 85 | `tortoise_session_context` | `tool_registry.py:676` | **no replacement** | `check_confidence` | absent |
| 86 | `tortoise_set_point_baseline` | `tool_registry.py:421` | **no replacement** | `refresh_confidence` | absent |
| 87 | `tortoise_set_source_tier` | `tool_registry.py:1002` | **no replacement** | `manage_source_trust` | absent |
| 88 | `tortoise_stale` | `tool_registry.py:816` | `tortoise_overview(section="stale")` | `graph_overview` | warning shim |
| 89 | `tortoise_status` | `tool_registry.py:659` | `tortoise_overview(section="status")` | `graph_overview` | warning shim |
...
| 92 | `tortoise_supersede` | `tool_registry.py:566` | **no replacement** | `supersede_knowledge` | absent |
| 93 | `tortoise_taxonomy` | `tool_registry.py:786` | `tortoise_overview(section="taxonomy")` | `graph_overview` | warning shim |
| 94 | `tortoise_traverse` | `tool_registry.py:613` | **no replacement** | `explore_connections` | absent |
| 95 | `tortoise_update` | `tool_registry.py:1053` | **no replacement** | `update_knowledge` | absent |
| 96 | `tortoise_update_entity` | `tool_registry.py:1023` | **no replacement** | `update_knowledge` | absent |
