...
- **Assertion:** all 342 pass; no file in the carve-out references `TORTOISE_DB_URI`; recovery auto-rebuild (D2/D3) and busy-error (D11) semantics verified embedded-only.
