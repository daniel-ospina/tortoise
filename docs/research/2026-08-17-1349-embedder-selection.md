...
- **2026 small-CPU best-in-class (ranked):**
  1. Qwen3-Embedding-0.6B — 768-dim (MRL), 32K ctx, LongMemEval R@10 78.71% — mem0's production default for memory retrieval
...
- bge-small-en-v1.5: 33.4M/384/~127MB/MIT, works without instruction prefix (v1.5), ~1.7-2x slower per encode than MiniLM on CPU.
- 384-dim constraint = false economy: reindex happens regardless; ~2,000-point pre-launch corpus; FalkorDB supports 1–4096 dims.
