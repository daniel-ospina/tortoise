...
**LFPDPPP note (non-blocking — RESOLVED 2026-08-08).** Per G-gate ②/D4, Premise Labs is not a registered entity; the contracting party is Daniel Ospina as an individual operating d/b/a "Premise Labs". The parties clause states jurisdiction of residence as Mexico (owner clarification 2026-08-08: Mexico-based, not incorporated; Delaware governing law kept as the forward-looking fundraising convention). The Mexican LFPDPPP applies to personal data of individuals in Mexico; a standalone Aviso de Privacidad is tracked as a follow-up (privacy reissue).
