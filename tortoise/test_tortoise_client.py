...
_TORTOISE_HOME = Path(os.environ.get("TORTOISE_HOME", str(Path(__file__).resolve().parent.parent)))
if str(_TORTOISE_HOME) not in sys.path:
    sys.path.insert(0, str(_TORTOISE_HOME))
