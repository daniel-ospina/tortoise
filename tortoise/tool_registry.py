...
TOOL_REGISTRY: list[ToolDefinition] = [
    ...
    ToolDefinition(
        ...
        description="Heterogeneous bulk write (epic #888 W4) — one call writes points + "
                    ...
                    "path: promote_source=False via #780); under gated an explicit "
                    "status:'live' on a point item is REJECTED (INGEST_CONTRACT row 9) — "
                    "use promotion_policy='auto' or promote after ingest via "
