...
# hash, and a one-sided presence is reported through the one-sided/uncarried
# channel — never silenced here. (`_upsert_point_edges` never reads the Source,
# so the replay can only reproduce what the payload states.)
