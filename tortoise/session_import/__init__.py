...
receipt only on 2xx (Task 15 acceptance: 403/503 ⇒ fail, no receipt, honest
error; a retryable 402/408/425/429/5xx is instead SPOOLED for a later drain by
``_spool_if_retryable``, #4714 — the import still exits non-zero and writes no
receipt; Codex + Desktop parsers idempotent on re-import).
