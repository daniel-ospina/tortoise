...
**What people value:**
- Genuine cost/latency advantage with no community-report build step (measured in its own §4.5, and corroborated by GraphRAG-Bench's **medical** dataset, where LightRAG scores **63.32 fact-retrieval accuracy vs MS-GraphRAG local's 38.63** — GPT-4o-mini generation table).
...
- [arXiv 2506.05690 — When to use Graphs in RAG (GraphRAG-Bench)](https://arxiv.org/html/2506.05690v3) — the Han et al. 2025 / Zhou et al. 2025 figures (-13.4%, -16.6%, +4.5%, 2.3×); the MS-GraphRAG-local recall 38.06 vs RAG 86.24 medical result; LightRAG 63.32 medical-dataset fact-retrieval accuracy (GPT-4o-mini generation table)
