...
4. Run '/reload' in Pi (or restart Pi) — tortoise connects eagerly at
   startup (the config doesn’t mark it lazy); '/reload' re-scans configs,
   skills, and MCP registrations.
5. Call tortoise_health — when it passes, tell me
