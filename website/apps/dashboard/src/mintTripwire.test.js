...
// (stripComments now lives in ./testSupport.js so the guards that OPT IN share
// one quote-aware implementation — see testSupport.js for the contract and its
// documented seams, and testSupport.test.js for the pins. Three other
// source-scanning guards still carry their own divergent strippers; unifying
// them is tracked by issue #3102.)
const mainJsxCode = stripComments(mainJsx)

// (stripComments unit tests moved to testSupport.test.js with the helper.)
