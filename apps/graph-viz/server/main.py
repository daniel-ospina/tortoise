...
@app.get("/api/health")
def health():
    """Health + graph discovery endpoint. Agents call this to find which graph is active."""
    return {
        "status": "ok",
        "graph": DB_GRAPH,
        "host": DB_HOST,
        ...
        "available_graphs": {
            "work": {"host": "localhost", "port": 16379, "password": None, "graph": "tortoise", "notes": "Main work graph (docker compose up)"},
            "test": {"host": "127.0.0.1", "port": 6379, "password": "falkordb", "graph": "tortoise", "notes": "Test/dev instance (481 claims)"},
            "medical": {"host": "localhost", "port": 16379, "password": None, "graph": "endometriosis_melasma", "notes": "Medical research graph"},
        },
    }
