...
if sys.version_info < (3, 12):  # noqa: UP036 — intentional RUNTIME guard
    raise SystemExit(
        f"graph-scripts/bp_approach_cycle4.py requires Python >= 3.12 (got "
        f"{sys.version_info[0]}.{sys.version_info[1]}) — run it as "
        f"`uv run python graph-scripts/bp_approach_cycle4.py`"
    )
...
pv = lambda quote: provenance("bp-approach-convergence", (0,0), quote, speaker="research-agent", extracted_by="manual@1.0")  # noqa: E731
ctxt = "bp-approach"
