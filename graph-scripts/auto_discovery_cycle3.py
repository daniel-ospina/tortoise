...
if sys.version_info < (3, 12):  # noqa: UP036 — intentional RUNTIME guard
    raise SystemExit(
        f"graph-scripts/auto_discovery_cycle3.py requires Python >= 3.12 (got "
        f"{sys.version_info[0]}.{sys.version_info[1]}) — run it as "
        f"`uv run python graph-scripts/auto_discovery_cycle3.py`"
    )
...
print(f"Cycle 3 complete: 8 evidence points, 7 IMPL edges, confidence revisions applied")  # noqa: F541
