...
EXPECTED_CLASSIFICATION = {
    ...
    # plain intake URL plus the intake's OWN inbound shared secret for the
    # website_contact producer (that secret can submit an item and nothing else —
    # no send, no read); the form is an intake producer (receiving is the
    # mechanism; sending is the exception), and #393 is a budget to manage —
    # never a reason to refuse to build.
